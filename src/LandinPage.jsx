      ...
      <div className="lp">
        ...
        <section className="lp-section" style={{ paddingBottom: 0 }}>
          ...
          <div className="lp-mosaic">
            ...
            <div className="lp-mosaic-img">
              <img
                src="https://images.unsplash.com/photo-1608855238293-a8853e7f7c98?w=600&q=80&auto=format&fit=crop"
                alt="Insumos y mise en place"
                loading="lazy"
              />
              <div className="lp-mosaic-caption">Mise en place</div>
            </div>
            <div className="lp-mosaic-img">
              <img
